...
/**
 * EmailValidatorMailDetailsBasic Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class EmailValidatorMailDetailsBasic implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailValidatorMailDetailsBasic';
    ...
    */
     ...
     * Sets id
     *
     * @param int|null $id the id of the email address
     *
     * @return self
     */
