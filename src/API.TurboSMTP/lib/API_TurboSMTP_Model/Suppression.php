...
class Suppression implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'date' => 'string',
        'sender' => 'string',
        'source' => '\API_TurboSMTP_Invoker\API_TurboSMTP_Model\SuppressionSource',
        'subject' => 'string',
        'recipient' => 'string',
        'reason' => 'string'
    ];
    ...
    */
    ...
    public function setDate($date)
    {
        ...
        if ((!preg_match("/(\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2})/", ObjectSerializer::toString($date)))) {
            throw new \InvalidArgumentException("invalid value for \$date when calling Suppression., must conform to the pattern /(\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2})/.");
        }
     ...
     * Sets source
     *
     * @param \API_TurboSMTP_Invoker\API_TurboSMTP_Model\SuppressionSource|null $source source
     *
     * @return self
     */
