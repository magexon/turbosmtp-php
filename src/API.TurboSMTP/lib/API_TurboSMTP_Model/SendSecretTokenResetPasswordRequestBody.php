...
/**
 * SendSecretTokenResetPasswordRequestBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class SendSecretTokenResetPasswordRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendSecretTokenResetPasswordRequestBody';
    ...
    */
     ...
     * Sets email
     *
     * @param string $email turboSMTP account email address.
     *
     * @return self
     */
