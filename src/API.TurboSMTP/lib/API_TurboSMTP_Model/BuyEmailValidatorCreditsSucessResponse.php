...
/**
 * BuyEmailValidatorCreditsSucessResponse Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class BuyEmailValidatorCreditsSucessResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BuyEmailValidatorCreditsSucessResponse';
    ...
    */
     ...
     * Sets url
     *
     * @param string|null $url Url to complete payment
     *
     * @return self
     */
