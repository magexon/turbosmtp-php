...
class AuthorizationError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const MESSAGE_MISSING_AUTHORIZATION_KEY = 'missing_authorization_key';
    public const MESSAGE_INVALID_AUTHORIZATION_KEY = 'invalid_authorization_key';
    ...
    {
        return [
            self::MESSAGE_MISSING_AUTHORIZATION_KEY,
            self::MESSAGE_INVALID_AUTHORIZATION_KEY,
        ];
    }
