...
/**
 * EmailValidatorList Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class EmailValidatorList implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailValidatorList';
    ...
    protected static $openAPITypes = [
        ...
        'total_emails' => 'int',
        'total_processed' => 'int',
        'status_summary' => '\API_TurboSMTP_Invoker\API_TurboSMTP_Model\EmailValidatorStatusSummaryItem[]'
    ];
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('total_emails', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['creation_time']) && !preg_match("/(\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2})/", $this->container['creation_time'])) {
            $invalidProperties[] = "invalid value for 'creation_time', must be conform to the pattern /(\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2})/.";
        }
     ...
     * Sets id
     *
     * @param int|null $id Email validation list id.
     *
     * @return self
     */
     ...
     * Sets creation_time
     *
     * @param string|null $creation_time Date and Time of the validation list creation.
     *
     * @return self
     */
    public function setCreationTime($creation_time)
    {
        ...
        if ((!preg_match("/(\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2})/", ObjectSerializer::toString($creation_time)))) {
            throw new \InvalidArgumentException("invalid value for \$creation_time when calling EmailValidatorList., must conform to the pattern /(\\d{4}-\\d{2}-\\d{2} \\d{2}:\\d{2}:\\d{2})/.");
        }
     ...
     * Sets file_name
     *
     * @param string|null $file_name File name of the uploaded file.
     *
     * @return self
     */
     ...
     * Sets is_processed
     *
     * @param bool|null $is_processed True if the validation list was already processed.
     *
     * @return self
     */
     ...
     * Sets percentage
     *
     * @param int|null $percentage Describes the percentage progress of validation list.
     *
     * @return self
     */
     ...
     * Sets total_emails
     *
     * @param int|null $total_emails Amount of email addresses in the validation list.
     *
     * @return self
     */
    public function setTotalEmails($total_emails)
    {
        if (is_null($total_emails)) {
            throw new \InvalidArgumentException('non-nullable total_emails cannot be null');
        }
     ...
     *
     * @param int|null $total_processed Describes the count of email addresses processed so far.
     *
     * @return self
     */
     ...
     * Gets status_summary
     *
     * @return \API_TurboSMTP_Invoker\API_TurboSMTP_Model\EmailValidatorStatusSummaryItem[]|null
     */
     ...
     * Sets status_summary
     *
     * @param \API_TurboSMTP_Invoker\API_TurboSMTP_Model\EmailValidatorStatusSummaryItem[]|null $status_summary status_summary
     *
     * @return self
     */
