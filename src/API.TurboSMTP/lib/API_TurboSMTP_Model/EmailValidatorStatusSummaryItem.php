...
/**
 * EmailValidatorStatusSummaryItem Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class EmailValidatorStatusSummaryItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailValidatorStatusSummaryItem';
    ...
    */
     ...
     * Sets total
     *
     * @param int|null $total Ammount of emails in the status within the list.
     *
     * @return self
     */
