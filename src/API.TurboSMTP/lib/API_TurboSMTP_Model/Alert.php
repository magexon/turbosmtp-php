...
class Alert implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function setPercentage($percentage)
    {
        ...
        if (($percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling Alert., must be smaller than or equal to 100.');
        }
        if (($percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling Alert., must be bigger than or equal to 0.');
        }
