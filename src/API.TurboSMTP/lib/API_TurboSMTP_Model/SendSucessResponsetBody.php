...
/**
 * SendSucessResponsetBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class SendSucessResponsetBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendSucessResponsetBody';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['mid']) && ($this->container['mid'] < 0)) {
            $invalidProperties[] = "invalid value for 'mid', must be bigger than or equal to 0.";
        }
