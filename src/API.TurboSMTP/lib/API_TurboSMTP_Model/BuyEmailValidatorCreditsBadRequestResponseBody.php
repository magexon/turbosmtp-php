...
/**
 * BuyEmailValidatorCreditsBadRequestResponseBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class BuyEmailValidatorCreditsBadRequestResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BuyEmailValidatorCreditsBadRequestResponseBody';
    ...
    public const MESSAGE_MISSING_REQUIRED_PARAMETER_AMOUNT = 'missing_required_parameter_amount';
    public const MESSAGE_AMOUNT_SHOULD_BE_INTEGER = 'amount_should_be_integer';
    public const MESSAGE_AMOUNT_SHOULD_NOT_BE_LESS_THAN_15 = 'amount_should_not_be_less_than_15';
    public const MESSAGE_AMOUNT_SHOULD_NOT_BE_HIGHER_THAN_1800 = 'amount_should_not_be_higher_than_1800';
    ...
    {
        return [
            self::MESSAGE_MISSING_REQUIRED_PARAMETER_AMOUNT,
            self::MESSAGE_AMOUNT_SHOULD_BE_INTEGER,
            self::MESSAGE_AMOUNT_SHOULD_NOT_BE_LESS_THAN_15,
            self::MESSAGE_AMOUNT_SHOULD_NOT_BE_HIGHER_THAN_1800,
        ];
    }
