...
/**
 * SuppressionImportJson Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class SuppressionImportJson implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuppressionImportJson';
    ...
    */
     ...
     * Sets reason
     *
     * @param string|null $reason Specifies a reason for suppressing imported email address/addresses
     *
     * @return self
     */
     ...
     * Sets content
     *
     * @param string[]|null $content List of email addresses to suppress.
     *
     * @return self
     */
