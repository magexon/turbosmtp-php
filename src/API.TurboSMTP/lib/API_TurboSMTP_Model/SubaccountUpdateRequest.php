...
/**
 * SubaccountUpdateRequest Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class SubaccountUpdateRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubaccountUpdateRequest';
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['policy_agree'] === null) {
            $invalidProperties[] = "'policy_agree' can't be null";
        }
        ...
        if (!is_null($this->container['confirm_password']) && (mb_strlen($this->container['confirm_password']) < 10)) {
            $invalidProperties[] = "invalid value for 'confirm_password', the character length must be bigger than or equal to 10.";
        }
     ...
     * Sets ip
     *
     * @param string $ip IP address to use for sending emails.
     *
     * @return self
     */
     ...
     * Sets first_name
     *
     * @param string $first_name subaccount owner first name
     *
     * @return self
     */
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling SubaccountUpdateRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling SubaccountUpdateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets last_name
     *
     * @param string $last_name subaccount owner last name
     *
     * @return self
     */
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling SubaccountUpdateRequest., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling SubaccountUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress1($address_1)
    {
        ...
        if (!is_null($address_1) && (mb_strlen($address_1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_1 when calling SubaccountUpdateRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($address_1) && (mb_strlen($address_1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_1 when calling SubaccountUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress2($address_2)
    {
        ...
        if (!is_null($address_2) && (mb_strlen($address_2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_2 when calling SubaccountUpdateRequest., must be smaller than or equal to 255.');
        }
        if (!is_null($address_2) && (mb_strlen($address_2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_2 when calling SubaccountUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SubaccountUpdateRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($city) && (mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SubaccountUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyName($company_name)
    {
        ...
        if (!is_null($company_name) && (mb_strlen($company_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling SubaccountUpdateRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($company_name) && (mb_strlen($company_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling SubaccountUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 64)) {
            throw new \InvalidArgumentException('invalid length for $country when calling SubaccountUpdateRequest., must be smaller than or equal to 64.');
        }
        if (!is_null($country) && (mb_strlen($country) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country when calling SubaccountUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) > 100)) {
            throw new \InvalidArgumentException('invalid length for $region when calling SubaccountUpdateRequest., must be smaller than or equal to 100.');
        }
        if (!is_null($region) && (mb_strlen($region) < 1)) {
            throw new \InvalidArgumentException('invalid length for $region when calling SubaccountUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setZipCode($zip_code)
    {
        ...
        if (!is_null($zip_code) && (mb_strlen($zip_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling SubaccountUpdateRequest., must be smaller than or equal to 10.');
        }
        if (!is_null($zip_code) && (mb_strlen($zip_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling SubaccountUpdateRequest., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling SubaccountUpdateRequest., must be smaller than or equal to 30.');
        }
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling SubaccountUpdateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets policy_agree
     *
     * @param bool $policy_agree Policy must be agreed in order to be able to create a subaccount.
     *
     * @return self
     */
    ...
    public function setSiteUrl($site_url)
    {
        ...
        if (!is_null($site_url) && (mb_strlen($site_url) > 45)) {
            throw new \InvalidArgumentException('invalid length for $site_url when calling SubaccountUpdateRequest., must be smaller than or equal to 45.');
        }
        if (!is_null($site_url) && (mb_strlen($site_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $site_url when calling SubaccountUpdateRequest., must be bigger than or equal to 1.');
        }
     ...
     * Sets password
     *
     * @param string|null $password subaccount password
     *
     * @return self
     */
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 10)) {
            throw new \InvalidArgumentException('invalid length for $password when calling SubaccountUpdateRequest., must be bigger than or equal to 10.');
        }
     ...
     *
     * @param string|null $confirm_password subaccount confirm password
     *
     * @return self
     */
    public function setConfirmPassword($confirm_password)
    {
        ...
        if ((mb_strlen($confirm_password) < 10)) {
            throw new \InvalidArgumentException('invalid length for $confirm_password when calling SubaccountUpdateRequest., must be bigger than or equal to 10.');
        }
