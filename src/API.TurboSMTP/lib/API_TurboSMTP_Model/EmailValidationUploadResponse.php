...
/**
 * EmailValidationUploadResponse Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class EmailValidationUploadResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailValidationUploadResponse';
    ...
    */
     ...
     * Sets list_id
     *
     * @param int|null $list_id List Identifier
     *
     * @return self
     */
     ...
     * Sets total_emails
     *
     * @param int|null $total_emails Total emails found in uploaded file
     *
     * @return self
     */
