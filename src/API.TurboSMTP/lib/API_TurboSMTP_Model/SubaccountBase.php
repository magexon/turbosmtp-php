...
/**
 * SubaccountBase Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class SubaccountBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubaccountBase';
    ...
    */
    ...
    public function setFirstName($first_name)
    {
        ...
        if ((mb_strlen($first_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling SubaccountBase., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($first_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $first_name when calling SubaccountBase., must be bigger than or equal to 1.');
        }
    ...
    public function setLastName($last_name)
    {
        ...
        if ((mb_strlen($last_name) > 50)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling SubaccountBase., must be smaller than or equal to 50.');
        }
        if ((mb_strlen($last_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $last_name when calling SubaccountBase., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress1($address_1)
    {
        ...
        if (!is_null($address_1) && (mb_strlen($address_1) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_1 when calling SubaccountBase., must be smaller than or equal to 255.');
        }
        if (!is_null($address_1) && (mb_strlen($address_1) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_1 when calling SubaccountBase., must be bigger than or equal to 1.');
        }
    ...
    public function setAddress2($address_2)
    {
        ...
        if (!is_null($address_2) && (mb_strlen($address_2) > 255)) {
            throw new \InvalidArgumentException('invalid length for $address_2 when calling SubaccountBase., must be smaller than or equal to 255.');
        }
        if (!is_null($address_2) && (mb_strlen($address_2) < 1)) {
            throw new \InvalidArgumentException('invalid length for $address_2 when calling SubaccountBase., must be bigger than or equal to 1.');
        }
    ...
    public function setCity($city)
    {
        ...
        if (!is_null($city) && (mb_strlen($city) > 100)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SubaccountBase., must be smaller than or equal to 100.');
        }
        if (!is_null($city) && (mb_strlen($city) < 1)) {
            throw new \InvalidArgumentException('invalid length for $city when calling SubaccountBase., must be bigger than or equal to 1.');
        }
    ...
    public function setCompanyName($company_name)
    {
        ...
        if (!is_null($company_name) && (mb_strlen($company_name) > 100)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling SubaccountBase., must be smaller than or equal to 100.');
        }
        if (!is_null($company_name) && (mb_strlen($company_name) < 1)) {
            throw new \InvalidArgumentException('invalid length for $company_name when calling SubaccountBase., must be bigger than or equal to 1.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 64)) {
            throw new \InvalidArgumentException('invalid length for $country when calling SubaccountBase., must be smaller than or equal to 64.');
        }
        if (!is_null($country) && (mb_strlen($country) < 1)) {
            throw new \InvalidArgumentException('invalid length for $country when calling SubaccountBase., must be bigger than or equal to 1.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) > 100)) {
            throw new \InvalidArgumentException('invalid length for $region when calling SubaccountBase., must be smaller than or equal to 100.');
        }
        if (!is_null($region) && (mb_strlen($region) < 1)) {
            throw new \InvalidArgumentException('invalid length for $region when calling SubaccountBase., must be bigger than or equal to 1.');
        }
    ...
    public function setZipCode($zip_code)
    {
        ...
        if (!is_null($zip_code) && (mb_strlen($zip_code) > 10)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling SubaccountBase., must be smaller than or equal to 10.');
        }
        if (!is_null($zip_code) && (mb_strlen($zip_code) < 1)) {
            throw new \InvalidArgumentException('invalid length for $zip_code when calling SubaccountBase., must be bigger than or equal to 1.');
        }
    ...
    public function setPhoneNumber($phone_number)
    {
        ...
        if (!is_null($phone_number) && (mb_strlen($phone_number) > 30)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling SubaccountBase., must be smaller than or equal to 30.');
        }
        if (!is_null($phone_number) && (mb_strlen($phone_number) < 1)) {
            throw new \InvalidArgumentException('invalid length for $phone_number when calling SubaccountBase., must be bigger than or equal to 1.');
        }
    ...
    public function setSiteUrl($site_url)
    {
        ...
        if (!is_null($site_url) && (mb_strlen($site_url) > 45)) {
            throw new \InvalidArgumentException('invalid length for $site_url when calling SubaccountBase., must be smaller than or equal to 45.');
        }
        if (!is_null($site_url) && (mb_strlen($site_url) < 1)) {
            throw new \InvalidArgumentException('invalid length for $site_url when calling SubaccountBase., must be bigger than or equal to 1.');
        }
