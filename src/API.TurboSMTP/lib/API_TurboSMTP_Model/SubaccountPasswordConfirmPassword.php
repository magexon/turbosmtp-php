...
/**
 * SubaccountPasswordConfirmPassword Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class SubaccountPasswordConfirmPassword implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SubaccountPasswordConfirmPassword';
    ...
    */
    ...
    public function setPassword($password)
    {
        ...
        if ((mb_strlen($password) < 10)) {
            throw new \InvalidArgumentException('invalid length for $password when calling SubaccountPasswordConfirmPassword., must be bigger than or equal to 10.');
        }
    ...
    public function setConfirmPassword($confirm_password)
    {
        ...
        if ((mb_strlen($confirm_password) < 10)) {
            throw new \InvalidArgumentException('invalid length for $confirm_password when calling SubaccountPasswordConfirmPassword., must be bigger than or equal to 10.');
        }
