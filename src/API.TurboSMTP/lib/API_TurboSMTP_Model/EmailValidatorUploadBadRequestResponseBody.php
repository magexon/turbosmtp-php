...
/**
 * EmailValidatorUploadBadRequestResponseBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class EmailValidatorUploadBadRequestResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailValidatorUploadBadRequestResponseBody';
    ...
    public const MESSAGE_MISSING_UPLOAD_FILEINVALID_MAIL_ADDRESS_LIST = 'missing_upload_file,invalid_mail_address_list';
    ...
    {
        return [
            self::MESSAGE_MISSING_UPLOAD_FILEINVALID_MAIL_ADDRESS_LIST,
        ];
    }
