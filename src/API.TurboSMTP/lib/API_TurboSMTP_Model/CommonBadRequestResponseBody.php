...
/**
 * CommonBadRequestResponseBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class CommonBadRequestResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CommonBadRequestResponseBody';
    ...
    public const MESSAGE_MISSING_REQUIRED_PARAMETER = 'missing_required_parameter';
    ...
    {
        return [
            self::MESSAGE_MISSING_REQUIRED_PARAMETER,
        ];
    }
