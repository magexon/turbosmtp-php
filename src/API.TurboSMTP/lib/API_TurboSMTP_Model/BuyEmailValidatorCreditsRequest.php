...
/**
 * BuyEmailValidatorCreditsRequest Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class BuyEmailValidatorCreditsRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BuyEmailValidatorCreditsRequest';
    ...
    */
     ...
     * Sets amount
     *
     * @param int|null $amount Amount of money to use for purchase
     *
     * @return self
     */
