 ...
 */
class AlertBase implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlertBase';
    ...
    */
     ...
     * Sets percentage
     *
     * @param int|null $percentage Percentage of usage that will trigger the alert
     *
     * @return self
     */
    public function setPercentage($percentage)
    {
        ...
        if (($percentage > 100)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling AlertBase., must be smaller than or equal to 100.');
        }
        if (($percentage < 0)) {
            throw new \InvalidArgumentException('invalid value for $percentage when calling AlertBase., must be bigger than or equal to 0.');
        }
