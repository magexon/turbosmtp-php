...
/**
 * AuthenticationLoginSucessResponsetBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class AuthenticationLoginSucessResponsetBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AuthenticationLoginSucessResponsetBody';
    ...
    */
     ...
     * Sets auth
     *
     * @param string|null $auth API Key to be used in authorization header
     *
     * @return self
     */
