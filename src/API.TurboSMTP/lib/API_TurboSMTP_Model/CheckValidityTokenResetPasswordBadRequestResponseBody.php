...
/**
 * CheckValidityTokenResetPasswordBadRequestResponseBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class CheckValidityTokenResetPasswordBadRequestResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckValidityTokenResetPasswordBadRequestResponseBody';
    ...
    public const MESSAGE_FORGOT_PASSWORD_TOKEN_IS_MISSING = 'forgot_password_token_is_missing';
    ...
    {
        return [
            self::MESSAGE_FORGOT_PASSWORD_TOKEN_IS_MISSING,
        ];
    }
