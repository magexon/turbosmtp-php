 ...
 */
class ConsumerKey implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ConsumerKey';
    ...
    */
     ...
     * Sets consumer_key
     *
     * @param string|null $consumer_key Consumer Key
     *
     * @return self
     */
     ...
     * Sets label
     *
     * @param string|null $label Consumer Key label.
     *
     * @return self
     */
     ...
     * Sets creation_time
     *
     * @param string|null $creation_time The time the consumer key was created.
     *
     * @return self
     */
    public function setCreationTime($creation_time)
    {
        ...
        if ((!preg_match("/(\\\\d{4}-\\\\d{2}-\\\\d{2} \\\\d{2}:\\\\d{2}:\\\\d{2})/", ObjectSerializer::toString($creation_time)))) {
            throw new \InvalidArgumentException("invalid value for \$creation_time when calling ConsumerKey., must conform to the pattern /(\\\\d{4}-\\\\d{2}-\\\\d{2} \\\\d{2}:\\\\d{2}:\\\\d{2})/.");
        }
