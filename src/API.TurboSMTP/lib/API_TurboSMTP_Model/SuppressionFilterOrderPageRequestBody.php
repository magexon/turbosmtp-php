...
/**
 * SuppressionFilterOrderPageRequestBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class SuppressionFilterOrderPageRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SuppressionFilterOrderPageRequestBody';
    ...
    */
    ...
    public function setPage($page)
    {
        ...
        if (!is_null($page) && ($page < 1)) {
            throw new \InvalidArgumentException('invalid value for $page when calling SuppressionFilterOrderPageRequestBody., must be bigger than or equal to 1.');
        }
     ...
     * Sets limit
     *
     * @param int|null $limit The numbers of rows per page to return
     *
     * @return self
     */
    public function setLimit($limit)
    {
        ...
        if (!is_null($limit) && ($limit < 1)) {
            throw new \InvalidArgumentException('invalid value for $limit when calling SuppressionFilterOrderPageRequestBody., must be bigger than or equal to 1.');
        }
