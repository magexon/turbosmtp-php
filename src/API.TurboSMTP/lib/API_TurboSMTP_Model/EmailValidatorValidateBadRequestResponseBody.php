...
/**
 * EmailValidatorValidateBadRequestResponseBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class EmailValidatorValidateBadRequestResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailValidatorValidateBadRequestResponseBody';
    ...
    public const MESSAGE_INVALID_MAIL_ADDRESS = 'invalid_mail_address';
    ...
    {
        return [
            self::MESSAGE_INVALID_MAIL_ADDRESS,
