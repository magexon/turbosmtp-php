...
/**
 * SendSecretTokenResetPasswordBadRequestResponseBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class SendSecretTokenResetPasswordBadRequestResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SendSecretTokenResetPasswordBadRequestResponseBody';
    ...
    public const MESSAGE_MISSING_REQUIRED_PARAMETER_EMAIL = 'missing_required_parameter_email';
    ...
    public function getMessageAllowableValues()
    {
        return [
            ...
            self::MESSAGE_MISSING_REQUIRED_PARAMETER_EMAIL,
        ];
    }
