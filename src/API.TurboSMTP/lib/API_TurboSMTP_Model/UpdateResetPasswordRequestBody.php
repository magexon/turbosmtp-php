...
/**
 * UpdateResetPasswordRequestBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class UpdateResetPasswordRequestBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UpdateResetPasswordRequestBody';
    ...
    */
     ...
     *
     * @param string $confirm_password New Password to be used.
     *
     * @return self
     */
