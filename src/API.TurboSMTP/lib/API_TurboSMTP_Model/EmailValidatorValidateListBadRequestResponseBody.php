...
/**
 * EmailValidatorValidateListBadRequestResponseBody Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class EmailValidatorValidateListBadRequestResponseBody implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'EmailValidatorValidateListBadRequestResponseBody';
    ...
    public const MESSAGE_LIST_ALREADY_VALIDATED = 'list_already_validated';
    public const MESSAGE_INSUFFICIENT_CREDIT = 'insufficient_credit';
    ...
    {
        return [
            self::MESSAGE_LIST_ALREADY_VALIDATED,
            self::MESSAGE_INSUFFICIENT_CREDIT,
        ];
    }
