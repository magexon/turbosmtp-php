...
/**
 * BaseAgencySettings Class Doc Comment
 *
 * @category Class
 * @package  API_TurboSMTP_Invoker
 * @author   OpenAPI Generator team
 ...
 */
class BaseAgencySettings implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'BaseAgencySettings';
    ...
    */
    ...
    public function setAgencyName($agency_name)
    {
        ...
        if ((mb_strlen($agency_name) > 128)) {
            throw new \InvalidArgumentException('invalid length for $agency_name when calling BaseAgencySettings., must be smaller than or equal to 128.');
        }
    ...
    public function setAgencyWebsite($agency_website)
    {
        ...
        if ((mb_strlen($agency_website) > 128)) {
            throw new \InvalidArgumentException('invalid length for $agency_website when calling BaseAgencySettings., must be smaller than or equal to 128.');
        }
    ...
    public function setAgencyFooter($agency_footer)
    {
        ...
        if ((mb_strlen($agency_footer) > 2048)) {
            throw new \InvalidArgumentException('invalid length for $agency_footer when calling BaseAgencySettings., must be smaller than or equal to 2048.');
        }
