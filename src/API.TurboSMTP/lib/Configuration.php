...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://pro.api.serversmtp.com/api/v2';
    ...
    {
        $report  = 'PHP SDK (API_TurboSMTP_Invoker) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 2.0.0-oas3' . PHP_EOL;
