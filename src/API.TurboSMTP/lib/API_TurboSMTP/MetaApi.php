...
class MetaApi
{
     ...
     * @return \API_TurboSMTP_Invoker\API_TurboSMTP_Model\Country[]|\API_TurboSMTP_Invoker\API_TurboSMTP_Model\AuthorizationError
     */
     ...
     * @throws \API_TurboSMTP_Invoker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \API_TurboSMTP_Invoker\API_TurboSMTP_Model\Country[]|\API_TurboSMTP_Invoker\API_TurboSMTP_Model\AuthorizationError, HTTP status code, HTTP response headers (array of strings)
     */
    public function getCountriesWithHttpInfo(string $contentType = self::contentTypes['getCountries'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\API_TurboSMTP_Invoker\API_TurboSMTP_Model\Country[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\API_TurboSMTP_Invoker\API_TurboSMTP_Model\Country[]' !== 'string') {
                            try {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\API_TurboSMTP_Invoker\API_TurboSMTP_Model\Country[]', []),
            ...
            $returnType = '\API_TurboSMTP_Invoker\API_TurboSMTP_Model\Country[]';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\API_TurboSMTP_Invoker\API_TurboSMTP_Model\Country[]',
    ...
    /**
     * Operation getStatesByCountry
     *
     * Get states by country
     *
     * @param  string $iso_code Country ISO code (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getStatesByCountry'] to see the possible values for this operation
     *
     * @throws \API_TurboSMTP_Invoker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return \API_TurboSMTP_Invoker\API_TurboSMTP_Model\State[]|\API_TurboSMTP_Invoker\API_TurboSMTP_Model\AuthorizationError|\API_TurboSMTP_Invoker\API_TurboSMTP_Model\CommonMessageResponseBody
     */
    public function getStatesByCountry($iso_code, string $contentType = self::contentTypes['getStatesByCountry'][0])
    {
        list($response) = $this->getStatesByCountryWithHttpInfo($iso_code, $contentType);
        return $response;
    }

    /**
     * Operation getStatesByCountryWithHttpInfo
     *
     * Get states by country
     *
     * @param  string $iso_code Country ISO code (required)
     ...
     * @throws \API_TurboSMTP_Invoker\ApiException on non-2xx response or if the response body is not in the expected format
     * @throws \InvalidArgumentException
     * @return array of \API_TurboSMTP_Invoker\API_TurboSMTP_Model\State[]|\API_TurboSMTP_Invoker\API_TurboSMTP_Model\AuthorizationError|\API_TurboSMTP_Invoker\API_TurboSMTP_Model\CommonMessageResponseBody, HTTP status code, HTTP response headers (array of strings)
     */
    public function getStatesByCountryWithHttpInfo($iso_code, string $contentType = self::contentTypes['getStatesByCountry'][0])
    {
        $request = $this->getStatesByCountryRequest($iso_code, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\API_TurboSMTP_Invoker\API_TurboSMTP_Model\State[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\API_TurboSMTP_Invoker\API_TurboSMTP_Model\State[]' !== 'string') {
                            try {
                                $content = json_decode($content, false, 512, JSON_THROW_ON_ERROR);
                            } catch (\JsonException $exception) {
                                throw new ApiException(
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\API_TurboSMTP_Invoker\API_TurboSMTP_Model\State[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\API_TurboSMTP_Invoker\API_TurboSMTP_Model\State[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\API_TurboSMTP_Invoker\API_TurboSMTP_Model\State[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getStatesByCountryAsync
     *
     * Get states by country
     *
     * @param  string $iso_code Country ISO code (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatesByCountryAsync($iso_code, string $contentType = self::contentTypes['getStatesByCountry'][0])
    {
        return $this->getStatesByCountryAsyncWithHttpInfo($iso_code, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getStatesByCountryAsyncWithHttpInfo
     *
     * Get states by country
     *
     * @param  string $iso_code Country ISO code (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getStatesByCountryAsyncWithHttpInfo($iso_code, string $contentType = self::contentTypes['getStatesByCountry'][0])
    {
        $returnType = '\API_TurboSMTP_Invoker\API_TurboSMTP_Model\State[]';
        $request = $this->getStatesByCountryRequest($iso_code, $contentType);
    ...
    /**
     * Create request for operation 'getStatesByCountry'
     *
     * @param  string $iso_code Country ISO code (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getStatesByCountry'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getStatesByCountryRequest($iso_code, string $contentType = self::contentTypes['getStatesByCountry'][0])
    {

        // verify the required parameter 'iso_code' is set
        if ($iso_code === null || (is_array($iso_code) && count($iso_code) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $iso_code when calling getStatesByCountry'
            );
        }


        $resourcePath = '/meta/state/{isoCode}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
